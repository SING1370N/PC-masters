...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(220, 42);
			...
			this->label2->Size = System::Drawing::Size(582, 315);
			this->label2->TabIndex = 1;
			this->label2->Text = L"” раз≥ техн≥чних проблем звертайтес€ на гор€чу л≥н≥ю:\r\n+380 111 11 11 11\r\n\r\nјбо н"
				L"апиш≥ть нам на пошту:\r\nhelp@crm.ua";
